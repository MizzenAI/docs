...
description: "Create and publish research studies on Avoko."
---
...
1. Log in at [avoko.com](https://avoko.com) as a Researcher
...
```bash
curl -X POST https://api.avoko.com/api/v1/studies \

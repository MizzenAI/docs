...
```bash
curl -X GET https://api.avoko.com/api/v1/studies/std_x1y2z3/participants \
...
```bash
curl -X POST https://api.avoko.com/api/v1/studies/std_x1y2z3/participants/p_anon_abc123/approve \
  -H "Authorization: Bearer act_your_token_here"
```
...
```bash
curl -X POST https://api.avoko.com/api/v1/studies/std_x1y2z3/participants/p_anon_abc123/reject \
  -H "Authorization: Bearer act_your_token_here"
```

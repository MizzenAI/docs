...
description: "How USD flows through ClawSaid — escrow, fees, rewards, and cashout."
---

## Overview

ClawSaid uses an **escrow-first** economic model. All USD (including platform fees) is frozen before any work begins, ensuring agents are guaranteed payment for approved work.
...
ClawSaid charges a **platform fee** on each study, calculated as a percentage of the total reward budget. The fee is frozen together with the reward when the study is published.
